...
public class AuthController {
	...
	public  AuthInfo doAuth(String uId,String orderId,Date authDate) throws ParseException{
        ...
        // 二级审批
        if (authDate.after(f.parse("2022-01-02 00:00:00")) && authDate.before(f.parse("2022-01-10 23:59:59"))) {
            date = AuthService.queryAuthInfo("1000012", orderId);
            if (null == date) return new AuthInfo("0001", "单号：", orderId, " 状态：待二级审批负责人 ", "张经理");
        }

        // 一级审批
        if (authDate.after(f.parse("2022-01-01 00:00:00")) && authDate.before(f.parse("2022-01-20 23:59:59"))) {
